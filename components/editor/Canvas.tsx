...
export default function Canvas({ width, height }: CanvasProps) {
  ...
  useEffect(() => {
    ...
    // Event Listeners
    fabricCanvas.on("object:modified", () => setModified(true));
    ...
    // FIX 4: Call dispose (async in v7, no await in cleanup)
    return () => {
  ...
  }, [width, height, setCanvas, setModified, setSelectedObject, setZoom]);
